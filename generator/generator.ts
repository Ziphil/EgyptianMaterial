...
import {CustomDocument} from "./dom";
import {CustomTemplateManager, CustomTransformer} from "./transformer";


export class CustomGenerator {

  private parser!: ZenmlParser;
  private transformer!: CustomTransformer;
  ...
  protected createTransformer(): CustomTransformer {
    const transformer = new CustomTransformer(() => new CustomDocument({includeDeclaration: false, html: true}));
...
export type SlideConfigs = {
  ...
  templateManagers?: Array<CustomTemplateManager>,
